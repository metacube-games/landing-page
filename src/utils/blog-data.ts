...
export const blogPosts: Record<string, BlogPost> = {
    ...
    "nft-collectibles-guide": {
        ...
        content: [
            ...
            { type: "paragraph", content: "In Metacube, NFT collectibles come in various rarity tiers, each influencing their uniqueness and potential value. These tiers are typically: **Common, Rare, Epic, Mythic and Legendary**. The rarer the item, the more distinct its attributes and appearance." },
            { type: "paragraph", content: "• Common: Weight 9+\n• rare: Weight 7-8\n• Epic: Weight 5-6\n• Mythic: Weight 2-4\n• Legendary: Weight 1" },
            { type: "image", content: "/blog/raritynft.png", alt: "NFT Rarity Distribution Chart" },
            { type: "paragraph", content: "The distribution of these rarities is carefully managed to ensure a balanced and engaging collecting experience." },
    ...
    "starknet-signatures-guide": {
        ...
        content: [
            ...
            { type: "heading", content: "Working with a wallet (Ready Wallet, Braavos, etc.)" },
            { type: "paragraph", content: "When working with a wallet like Ready Wallet or Braavos, you typically won't have direct access to the user's private key. Instead, you'll need to use the wallet's interface to request the user to sign a message." },
            {
                type: "code",
                language: "typescript",
