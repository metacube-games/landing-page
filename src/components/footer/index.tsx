                ...
                <div className="flex space-x-8">
                    <div>
                        ...
                        <ul>
                            ...
                            <li className='my-2'><span className='hover:opacity-75'><SocialIcon url='https://discord.com/invite/FGV6HkMbNj' bgColor='transparent' style={{ height: 24, width: 24 }} target="_blank" rel="noopener noreferrer"/><Link href="https://discord.gg/C83Ta7qYRP" target="_blank" rel="noopener noreferrer">Discord</Link></span></li>
