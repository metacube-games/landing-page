  ...
  return (
    <section className="flex flex-col items-center justify-center relative mb-24">
      ...
      <p className="text-center text-gray-300 mb-8 max-w-3xl mx-auto px-4">
        Watch incredible content from our community members and be inspired. From epic gameplay moments to creative builds, 
        our players are constantly exploring the Metacube universe.
      </p>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[1000] p-4">
          <div className="bg-black/95 backdrop-blur-md p-8 rounded-lg border border-green-700/40 shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl uppercase tracking-wider font-semibold text-green-400">Submit Your Video</h3>
              <button
                onClick={closeModal}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-1 text-sm text-gray-400">Please provide a valid YouTube video link.</p>
                </div>
