  ...
  return (
    <div className="flex flex-col justify-center items-center relative mb-24 text-black">
      ...
      <blockquote className="twitter-tweet" data-media-max-width="560">
        <p lang="en" dir="ltr">
          🎮<a href="https://t.co/BQE1YWmNHr">pic.twitter.com/BQE1YWmNHr</a>
        </p>
        &mdash; Metacube (@MetacubeGames)
        <a
          rel="preload"
          href="https://twitter.com/MetacubeGames/status/1714343398247682273?ref_src=twsrc%5Etfw"
        >
          October 17, 2023
        </a>
      </blockquote>
